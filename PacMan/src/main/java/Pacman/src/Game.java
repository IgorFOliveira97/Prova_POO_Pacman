...
public class Game extends JFrame implements KeyListener {
	...
	private Booster booster = new Booster(400, 400,false,100);

	private JLabel imgPlayer = new JLabel(new ImageIcon("Imagens/pacman.png"));
	private JLabel imgGhost1 = new JLabel(new ImageIcon("Imagens/ghost.png"));
	private JLabel imgGhost2 = new JLabel(new ImageIcon("Imagens/ghost.png"));
	private JLabel imgGhost3 = new JLabel(new ImageIcon("Imagens/ghost.png"));
	private JLabel imgGhost4 = new JLabel(new ImageIcon("Imagens/ghost.png"));
	private JLabel imgBomb = new JLabel(new ImageIcon("Imagens/bomb.png"));
	private JLabel imgBooster = new JLabel(new ImageIcon("Imagens/booster.png"));
